...
<head>
  ...
  <link rel="shortcut icon" href="${request.static_url('giteverywhere:static/favicon.ico')}" />
  <link rel="stylesheet" href="${request.static_url('giteverywhere:static/pyck.css')}" type="text/css" media="screen" charset="utf-8" />
  <link rel="stylesheet" href="http://static.pylonsproject.org/fonts/nobile/stylesheet.css" media="screen" />
  <link rel="stylesheet" href="http://static.pylonsproject.org/fonts/neuton/stylesheet.css" media="screen" />
  <!--[if lte IE 6]>
  <link rel="stylesheet" href="${request.static_url('giteverywhere:static/ie6.css')}" type="text/css" media="screen" charset="utf-8" />
  <![endif]-->
...
<%def name="header()">
  <div id="top-small">
    <img src="${request.static_url('giteverywhere:static/pyck-small.png')}"  alt="pyck"/>
    ${self.main_menu()}
  </div>
</%def>
